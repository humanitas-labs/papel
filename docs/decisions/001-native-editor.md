...
> Papel uses the native macOS document lifecycle with an AppKit editing
...
- Build Papel as a macOS-native Swift application.
...
or if Papel must support non-Apple platforms.
