...
struct UpdateCheckTests {
    ...
    func releaseParsesTheTagAndPointsAtTheStableDownload() {
        let body = Data(#"{"tag_name":"v0.7.0","name":"Paper 0.7.0","assets":[{"name":"Paper.dmg"}]}"#.utf8)
        let release = UpdateCheck.release(from: body)
        #expect(release?.version == "0.7.0")
        #expect(release?.url.absoluteString == "https://github.com/humanitas-labs/paper/releases/latest/download/Paper.dmg")
