...
struct ImageTests {
    ...
    private let folder: URL = {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("papel-image-tests-\(UUID().uuidString)", isDirectory: true)
    ...
    private func styledView(_ text: String, documentURL: URL? = nil) -> PapelTextView {
    ...
    private func spacing(at location: Int, in textView: PapelTextView) -> CGFloat {
