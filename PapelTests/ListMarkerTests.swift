...
struct ListMarkerTests {
    ...
    func dashAndStarRenderAsDashAndBulletOffTheActiveParagraph() throws {
        ...
        let dash = try #require(PapelLayoutManager.glyph(for: "–", in: dashFont))
        let bullet = try #require(PapelLayoutManager.glyph(for: "•", in: bulletFont))
        let hyphen = try #require(PapelLayoutManager.glyph(for: "-", in: dashFont))
    ...
    func arrowsDrawAsOneGlyphOffTheActiveParagraph() throws {
        ...
        let arrow = try #require(PapelLayoutManager.glyph(for: "→", in: font))
