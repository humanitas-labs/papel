...
struct ThemeTests {
    ...
    func themeKeysParseAndOverridesApply() {
        ...
        #expect(Configuration.parse("task.indent = 0").taskIndent == 0, "on the margin")
        #expect(Configuration.parse("task.indent = 500").taskIndent == 80, "clamped")
        #expect(Configuration.parse("task.indent = far").taskIndent == 10, "default")
