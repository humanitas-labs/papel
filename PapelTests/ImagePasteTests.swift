...
struct ImagePasteTests {
    private let folder: URL = {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("papel-image-paste-\(UUID().uuidString)", isDirectory: true)
    ...
    func pasteboardSourcePrefersAFileThenPNGThenTIFF() throws {
        let pasteboard = NSPasteboard(name: NSPasteboard.Name("papel-test-\(UUID().uuidString)"))
    ...
    private func styledView(_ text: String) -> PapelTextView {
